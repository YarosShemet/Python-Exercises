print("Вас приветствует программа шифрования!")
direct = input("Выберите режим: шифрование или дешифрование - ")
cnt = int(input("Введите шаг кодировки:"))
...
if direct == "шифрование":
    cipher(text)
elif direct == "дешифрование":
    decipher(text)
